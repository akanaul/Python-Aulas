...
# ==========================================
# EXERCÍCIO DE SISTEMA DE AUDITORIA COM IA
# ==========================================
# 🤖 Aplique o prompt de auditoria ensinado na aula para auditar o seu próprio código acima.
# Liste abaixo pelo menos 3 verificações realizadas pela IA:
# 1. 
# 2. 
# 3.
...
# 💡 O Gabarito Manual Comentado está no arquivo separado: aula_08_exercicios_gabarito.py

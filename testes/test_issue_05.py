# -*- coding: utf-8 -*-
"""
Suíte de Testes Unitários Automatizados — Issue #05
...
class TestIssue_05(unittest.TestCase):
    """Testes automatizados comportamentais da Issue #05."""

    def setUp(self):
        self.curr_dir = os.path.dirname(os.path.abspath(__file__))
        self.root_dir = os.path.abspath(os.path.join(self.curr_dir, ".."))
        self.rel_path = r"02_python_essencial\pratica\Aula 05 - Listas Tuplas e Ranges\aula_05_exercicios_manual.py"
    ...
    def test_file_exists(self):
        ...
        if not os.path.exists(self.manual_path):
            ...
            for root, dirs, files in os.walk(self.root_dir):
                if "aula_05_exercicios_manual.py" in files:
                    self.manual_path = os.path.join(root, "aula_05_exercicios_manual.py")
                    found = True
                    break
            self.assertTrue(found or os.path.exists(self.manual_path), f"Arquivo aula_05_exercicios_manual.py da Issue #05 não encontrado.")
        else:
            self.assertTrue(os.path.exists(self.manual_path))

    def test_file_syntax(self):
        """Valida a sintaxe Python do arquivo de prática da Issue #05."""
        if self.manual_path.endswith(".py") and os.path.exists(self.manual_path):
            ...
            try:
                ...
                self.fail(f"Erro de sintaxe Python na Issue #05: {e}")

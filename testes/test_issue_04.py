...
class TestStudentExercise_04(unittest.TestCase):
    """Suíte de Testes Automatizados para a Issue #04."""

    def setUp(self):
        self.curr_dir = os.path.dirname(os.path.abspath(__file__))
        self.root_dir = os.path.join(self.curr_dir, "..")
        self.file_path = os.path.normpath(os.path.join(self.root_dir, "02_python_essencial/pratica/Aula 04 - Strings e Formatação/aula_04_exercicios_manual.py"))

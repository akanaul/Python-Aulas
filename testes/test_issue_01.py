...
class TestStudentExercise_01(unittest.TestCase):
    """Suíte de Testes Automatizados para a Issue #01."""

    def setUp(self):
        self.curr_dir = os.path.dirname(os.path.abspath(__file__))
        self.root_dir = os.path.join(self.curr_dir, "..")
        self.file_path = os.path.normpath(os.path.join(self.root_dir, "01_fundamentos/pratica/Aula 01 - Setup e Primeiros Passos/aula_01_exercicios_manual.py"))

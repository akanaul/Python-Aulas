...
class TestStudentExercise_12(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.file_path = os.path.normpath(os.path.join(self.root_dir, r"04_bibliotecas_arquivos\Aula 12 - Email Automatico e Agendamento\aula_12_exercicios_manual.py"))

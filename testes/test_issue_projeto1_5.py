# -*- coding: utf-8 -*-
"""
Suíte de Testes Unitários Automatizados — Issue #projeto1_5
...
class TestIssue_PROJETO1_5(unittest.TestCase):
    """Testes automatizados comportamentais da Issue #projeto1_5."""

    def setUp(self):
        self.curr_dir = os.path.dirname(os.path.abspath(__file__))
        self.root_dir = os.path.abspath(os.path.join(self.curr_dir, ".."))
        self.rel_path = r"03_poo\pratica\Projeto 1.5 - Sistema de Gestao de Motoristas em POO\projeto_manual.py"
        ...
        if not os.path.exists(self.manual_path):
            ...
            for root, dirs, files in os.walk(self.root_dir):
                if "projeto_manual.py" in files:
                    ...
                    found = True
                    break
            self.assertTrue(found or os.path.exists(self.manual_path), f"Arquivo projeto_manual.py da Issue #projeto1_5 não encontrado.")
        else:
            self.assertTrue(os.path.exists(self.manual_path))

    def test_file_syntax(self):
        """Valida a sintaxe Python do arquivo de prática da Issue #projeto1_5."""
        if self.manual_path.endswith(".py") and os.path.exists(self.manual_path):
            ...
            try:
                ...
                self.fail(f"Erro de sintaxe Python na Issue #projeto1_5: {e}")

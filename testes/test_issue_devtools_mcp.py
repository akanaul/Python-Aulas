...
class TestStudentExercise_DEVTOOLS_MCP(unittest.TestCase):
    """Suíte de Testes Automatizados Comportamentais para a Issue #devtools_mcp."""

    def setUp(self):
        self.curr_dir = os.path.dirname(os.path.abspath(__file__))
        self.root_dir = os.path.join(self.curr_dir, "..")
        self.manual_path = os.path.normpath(os.path.join(self.root_dir, "07_bonus_selenium/pratica/Aula Bonus - Selenium A Proxima Fronteira/devtools_mcp_manual.py"))
        self.gabarito_path = os.path.normpath(os.path.join(self.root_dir, "07_bonus_selenium/pratica/Aula Bonus - Selenium A Proxima Fronteira/devtools_mcp_gabarito.py"))

...
class TestStudentExercise_09A(unittest.TestCase):
    """Suíte de Testes Automatizados Comportamentais para a Issue #09a."""

    def setUp(self):
        self.curr_dir = os.path.dirname(os.path.abspath(__file__))
        self.root_dir = os.path.join(self.curr_dir, "..")
        self.manual_path = os.path.normpath(os.path.join(self.root_dir, "03_poo/pratica/Aula 09A - Modulos e POO Basico/aula_09a_exercicios_manual.py"))
        self.gabarito_path = os.path.normpath(os.path.join(self.root_dir, "03_poo/pratica/Aula 09A - Modulos e POO Basico/aula_09a_exercicios_gabarito.py"))

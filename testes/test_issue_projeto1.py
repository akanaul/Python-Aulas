# -*- coding: utf-8 -*-
"""
Suíte de Testes Unitários Automatizados — Issue #projeto1
...
class TestIssue_PROJETO1(unittest.TestCase):
    """Testes automatizados comportamentais da Issue #projeto1."""

    def setUp(self):
        self.curr_dir = os.path.dirname(os.path.abspath(__file__))
        self.root_dir = os.path.abspath(os.path.join(self.curr_dir, ".."))
        self.rel_path = r"01_fundamentos\pratica\Projeto 1 - Ficha de Cadastro de Motorista\projeto_manual.py"
        ...
        if not os.path.exists(self.manual_path):
            ...
            for root, dirs, files in os.walk(self.root_dir):
                if "projeto_manual.py" in files:
                    ...
                    found = True
                    break
            self.assertTrue(found or os.path.exists(self.manual_path), f"Arquivo projeto_manual.py da Issue #projeto1 não encontrado.")
        else:
            self.assertTrue(os.path.exists(self.manual_path))

    def test_file_syntax(self):
        """Valida a sintaxe Python do arquivo de prática da Issue #projeto1."""
        if self.manual_path.endswith(".py") and os.path.exists(self.manual_path):
            ...
            try:
                ...
                self.fail(f"Erro de sintaxe Python na Issue #projeto1: {e}")

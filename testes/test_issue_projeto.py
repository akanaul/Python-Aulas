...
class TestStudentExercise_PROJETO(unittest.TestCase):
    """Suíte de Testes Automatizados Comportamentais para a Issue #projeto."""

    def setUp(self):
        self.curr_dir = os.path.dirname(os.path.abspath(__file__))
        self.root_dir = os.path.join(self.curr_dir, "..")
        self.manual_path = os.path.normpath(os.path.join(self.root_dir, "01_fundamentos/pratica/Mini-Projeto 1 - Gerador de Ficha de Motorista/projeto_manual.py"))
        self.gabarito_path = os.path.normpath(os.path.join(self.root_dir, "01_fundamentos/pratica/Mini-Projeto 1 - Gerador de Ficha de Motorista/projeto_gabarito.py"))
